...
/**
 * A <code>AnypointPlatformAnalyticsConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link AnypointPlatformAnalyticsConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.1", date = "2015-12-15T09:00:52-03:00", comments = "Build UNNAMED.2613.77421cc")
public class AnypointPlatformAnalyticsConnectorLifecycleInjectionAdapter
    extends AnypointPlatformAnalyticsConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(AnypointPlatformAnalyticsConnectorLifecycleInjectionAdapter.class);
